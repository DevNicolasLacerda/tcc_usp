...
<body>
    <header class="headerLogin">
            ...
            ?>
        <a class="btnvoltarLogin" href="index.html"><i class="fa-solid fa-arrow-right fa-xl"></i></a>
    </header>
        ...
        <div class="container">
            ...
            <div class="footer-links-2">
                <ul class="flex">
                    ...
                    <li>
                        <a href="contact.html">Duvida</a>
                    </li>
                </ul>
            </div>

            <p class="text">&copy; <a href="#">Educenter</a>. All Rights Reserved.</p>
        </div>
    </footer>
